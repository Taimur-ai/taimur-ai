    ...
    <section id="journey" aria-label="Journey Timeline" style={{ padding: "100px 32px", maxWidth: 860, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        ...
        <p style={{
          ...
          This is Day 0. Follow the daily evolution from traditional finance to AI-augmented workflows.
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    <span style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 16, fontWeight: 700, color: "#1a1a1a" }}>Day 0</span>
